            ...
            <md-card flex="100" flex-gt-md="66">
                ...
                <md-card-content>
                    <video id="timelapse-video" class="video-js vjs-default-skin vjs-big-play-centered"
                        ...
                        <source src="//video.revyweather.com/<?php echo $yesterdayVideo ?>.mp4" type="video/mp4">
                        <source src="//video.revyweather.com/<?php echo $yesterdayVideo ?>.webm" type="video/webm">
