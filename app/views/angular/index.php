<div data-ng-app="rightNowApp" ng-cloak>
    <div data-ng-controller="RightNowController">
        ...
        <div data-ng-show="showCourthouseLoader" class="loader col-md-12"><img src="assets/img/loader.gif"></div>
        <div data-ng-hide="showCourthouseLoader">
            <div class="col-md-12">
        ...
        <div data-ng-show="showForecastioLoader" class="loader col-md-12"><img src="assets/img/loader.gif"></div>
        <div data-ng-hide="showForecastioLoader">
            <div class="col-md-12">
        ...
        <div data-ng-show="showAirportLoader" class="loader col-md-12"><img src="assets/img/loader.gif"></div>
        <div data-ng-hide="showAirportLoader">
            <div class="col-md-12">
